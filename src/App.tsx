...
export function App() {
  ...
  const handleEmailList = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
      ...
      {isGuestsModalVisible && (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={handleEmailList} className='p-2.5 bg-zinc-950 border-l-zinc-800 rounded-lg flex items-center gap-2'>
